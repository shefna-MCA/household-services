...
public class PaymentActivity extends AppCompatActivity {
    ...
    String bookingId,fees,serviceId;
    ...
    private void payNow() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+ ip +"/home_service/api/payment.php", new Response.Listener<String>() {
            @Override
    ...
    private void showAlert() {
        ...
        alertDialogBuilder.setMessage("The amount has been Credited to the Service Providers Account");
